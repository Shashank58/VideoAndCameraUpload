...
public class AppUtils {
    ...
    public static String getAbsolutePathPostKitkat(final Context context, final Uri uri) {
    ...
    public static String getAbsolutePathPreKitKat(Context context, Uri contentURI) {
        String result;
